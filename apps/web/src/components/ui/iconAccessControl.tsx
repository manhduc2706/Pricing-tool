export default function IconAccessControl() {
  return (
    ...
    >
      ...
      ></path>
      <path
        d="M13.3333 2.60834C14.0503 2.79192 14.6858 3.20892 15.1396 3.7936C15.5935 4.37827 15.8398 5.09736 15.8398 5.8375C15.8398 6.57765 15.5935 7.29674 15.1396 7.88141C14.6858 8.46609 14.0503 8.88309 13.3333 9.06667"
        stroke="#0F4FAF"
        stroke-width="1.66667"
        stroke-linecap="round"
        stroke-linejoin="round"
